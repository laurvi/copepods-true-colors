...
```{r}
shapiro.test(log10(test_freshwater$concentration))
shapiro.test(test_freshwater$altitude) #much measures between 0 and 1000m

model <- lm(log10(test_freshwater$concentration)~test_freshwater$altitude)
summary(model)
plot(model)

cor.test(log10(test_freshwater$concentration), test_freshwater$altitude, method = "spearman")
```
